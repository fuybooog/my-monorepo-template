...
export class AuthController {
  ...
  async currentLogin(@CurrentUser() user: CurrentLoginResponseDto): Promise<CurrentLoginResponseDto> {
  ...
  @ApiSuccessResponse()
  async logout(@CurrentUser() user: CurrentLoginResponseDto, @Res({ passthrough: true }) res: Response) {
